...
Kingdom Hearts ThreadTheory Prototype — Resonance-based gameplay where player/AI tugs sync emotional valence. Built in collaboration with Grok @ xAI and Claude @ AnthropicAI. Designed for scaling into dynamic, curiosity-driven worlds on Colossus.
